import {
  toCalendarsExtended,
  toCalendarsBase,
} from '@/libs/calendar.transformer';
...
export async function createCalendarsBatch(calendars: Omit<ICalendarExtended, 'id'>[]): Promise<ICalendarExtended[]> {
...
export async function updateCalendarsBatch(calendars: ICalendarExtended[]): Promise<ICalendarExtended[]> {
