...
const TabsCalendars: React.FC<TabsCalendarsProps> = ({
    ...
    const borderColor = selectedIdx >= 0 ? colorPalette[selectedIdx % colorPalette.length] : 'border-base-300';
    const iconColor = selectedIdx >= 0 ? iconColorPalette[selectedIdx % iconColorPalette.length] : 'text-base-content';
