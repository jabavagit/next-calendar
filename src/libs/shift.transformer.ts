...
export const toShiftsExtended = (data: IShift[]): IShiftExtended[] =>
  data.map(toShiftExtended);
...
export const toShiftsBase = (data: IShiftExtended[]): IShift[] =>
  data.map(toShiftBase);